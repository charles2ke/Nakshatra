...
- The workflow runs `actions/configure-pages` with `enablement: true`, which sets the Pages
  source to GitHub Actions. Otherwise the legacy branch-based build publishes a rendered
